...
urlpatterns = [
    ...
    ),  # obtain jwt with email and password
    path(
    ...
    path(
        ...
        views.QuoteDeleteAPIView.as_view(),
        name="quote-delete",
    ),
    path("jobs/<int:pk>/update/", views.JobUpdateAPIView.as_view(), name="job-update"),
    path(
        "quotes/<int:pk>/update/",
        views.QuoteUpdateAPIView.as_view(),
        name="quote-update",
    ),
    path(
        "quotes/<int:pk>/agree/", views.AgreeQuoteAPIView.as_view(), name="quote-agree"
    ),
]
